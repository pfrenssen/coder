 ...
 *
 * Copied from PHP_CodeSniffer\Util\Writers\StatusWriter because that internal class is not
 * available through the autoloader.
 *
 * ---------------------------------------------------------------------------------------------
 ...
 * @license   https://github.com/PHPCSStandards/PHP_CodeSniffer/blob/HEAD/licence.txt BSD License
 */

namespace Drupal\Coder\Util;
