...
use Drupal\Coder\Util\StatusWriter;
    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        for ($i = ($stackPtr + 1); $i < $phpcsFile->numTokens; $i++) {
            ...
            */
            ...
            // Don't perform strict checking if the line begins after a comma.
            if ($checkToken !== null && $exact === true) {
                $prev = $phpcsFile->findPrevious(Tokens::EMPTY_TOKENS, ($checkToken - 1), null, true);
