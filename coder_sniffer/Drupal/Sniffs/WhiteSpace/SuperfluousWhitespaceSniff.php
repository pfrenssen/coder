<?php
/**
 * Drupal_Sniffs_WhiteSpace_SuperfluousWhitespaceSniff.
 *
 * PHP version 5
 *
 * @category PHP
...
/**
 * Largely copied from Squiz_Sniffs_WhiteSpace_SuperfluousWhitespaceSniff.
 *
 * Also checks that there are no trailing white spaces in doc comments.
 *
 * @category PHP
 * @package  PHP_CodeSniffer
 * @link     http://pear.php.net/package/PHP_CodeSniffer
 */
class Drupal_Sniffs_WhiteSpace_SuperfluousWhitespaceSniff implements PHP_CodeSniffer_Sniff
{
