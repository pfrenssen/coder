<?php
/**
 * Sniffs_Drupal_WhiteSpace_OperatorSpacingSniff.
 *
 * PHP version 5
 *
 * @category PHP
...
/**
 * Copied from Squiz_Sniffs_WhiteSpace_OperatorSpacingSniff with some bugfixes, see
 * this pull request: https://github.com/squizlabs/PHP_CodeSniffer/pull/40
 * @todo Remove this class when the fix is accepted and link the sniff from Squiz in
 * ruleset.xml.
 *
